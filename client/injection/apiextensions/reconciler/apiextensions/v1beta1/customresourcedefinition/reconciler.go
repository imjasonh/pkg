...
// controller reconciling v1beta1.CustomResourceDefinition.
type Interface interface {
	// ReconcileKind implements custom logic to reconcile v1beta1.CustomResourceDefinition. Any changes
	// to the objects .Status or .Finalizers will be propagated to the stored
	// object. It is recommended that implementors do not call any update calls
	// for the Kind inside of ReconcileKind, it is the responsibility of the calling
	// controller to propagate those properties. The resource passed to ReconcileKind
	// will always have an empty deletion timestamp.
	ReconcileKind(ctx context.Context, o *v1beta1.CustomResourceDefinition) reconciler.Event
}

// Finalizer defines the strongly typed interfaces to be implemented by a
// controller finalizing v1beta1.CustomResourceDefinition.
type Finalizer interface {
	// FinalizeKind implements custom logic to finalize v1beta1.CustomResourceDefinition. Any changes
...
func (r *reconcilerImpl) updateStatus(ctx context.Context, existing *v1beta1.CustomResourceDefinition, desired *v1beta1.CustomResourceDefinition) error {
...
func (r *reconcilerImpl) setFinalizerIfFinalizer(ctx context.Context, resource *v1beta1.CustomResourceDefinition) (*v1beta1.CustomResourceDefinition, error) {
...
func (r *reconcilerImpl) clearFinalizer(ctx context.Context, resource *v1beta1.CustomResourceDefinition, reconcileEvent reconciler.Event) (*v1beta1.CustomResourceDefinition, error) {
	if _, ok := r.reconciler.(Finalizer); !ok {
		return resource, nil
	}
	if resource.GetDeletionTimestamp().IsZero() {
